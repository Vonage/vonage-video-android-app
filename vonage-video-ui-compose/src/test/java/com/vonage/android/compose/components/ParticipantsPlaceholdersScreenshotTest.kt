...
class ParticipantsPlaceholdersScreenshotTest {
    ...
    @Test
    fun participantsPlaceholders_light() {
        composeTestRule.setContent { ParticipantsPlaceholdersPreview() }
        composeTestRule.onRoot().captureRoboImage(roborazziOptions = options)
    }

    @Test
    @Config(qualifiers = "+night")
    fun participantsPlaceholders_dark() {
        composeTestRule.setContent { ParticipantsPlaceholdersPreview() }
        composeTestRule.onRoot().captureRoboImage(roborazziOptions = options)
    }
}
