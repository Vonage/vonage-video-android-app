# Contributing to Vonage Video Android App
...
- Browse the [open issues](https://github.com/Vonage/vonage-video-android-app/issues) to see what needs attention.
