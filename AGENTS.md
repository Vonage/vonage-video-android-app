...
- `app-config.json` is the single source of truth for feature toggles and `baseApiUrl`.
...
- Theme is generated from `theme.json` by `com.vonage.theme-generator` into `vonage-video-ui-compose/src/main/java/com/vonage/android/compose/theme/`. Do not edit generated theme files directly.
...
# After any app-config.json or theme.json edit
