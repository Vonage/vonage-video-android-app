...
fun AdaptiveGrid(
    ...
    BoxWithConstraints(modifier = modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        ...
        val itemHeight = with(LocalDensity.current) { (constraints.maxHeight / rows).toDp() - spacing }
        val itemWidth = with(LocalDensity.current) { (constraints.maxWidth / columns).toDp() - spacing }
