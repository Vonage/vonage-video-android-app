---
applyTo: "{*.json,gradle/**/*.properties,**/*.gradle,**/*.gradle.kts,build-tools/**/*.kt}"
---

# Config and Build Instructions

- `app-config.json` is the source of truth for feature toggles and `baseApiUrl` placeholder values.
...
- Keep plugin-driven generation intact:
  ...
  - `com.vonage.theme-generator` for Compose theme output from `theme.json`.
