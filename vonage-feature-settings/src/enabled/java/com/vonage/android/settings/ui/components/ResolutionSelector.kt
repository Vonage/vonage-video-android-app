...
internal fun ResolutionSelector(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.settings_resolution_note),
        ...
        ExposedDropdownMenuBox(
            ...
            OutlinedTextField(
                value = selected?.label ?: AUTO_LABEL,
                onValueChange = {},
                readOnly = true,
                ...
                label = {
                    Text(
                        text = stringResource(R.string.settings_resolution_label),
                        style = VonageVideoTheme.typography.caption,
                    )
                },
            )
                ...
                DropdownMenuItem(
                    text = {
                        Column {
                            ...
                            Text(
                                text = "Selects resolution based on device memory",
                                style = VonageVideoTheme.typography.caption,
                                color = VonageVideoTheme.colors.tertiary,
                            )
                        }
