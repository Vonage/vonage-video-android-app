...
include(":vonage-feature-audio-effects")
include(":vonage-feature-captions")
include(":vonage-feature-okta")
include(":vonage-feature-settings")
include(":vonage-audio-selector")
include(":vonage-android-logger")
include(":vonage-config-idea-plugin")
include(":vonage-meeting-room")
include(":vonage-meeting-room-sample-app")
