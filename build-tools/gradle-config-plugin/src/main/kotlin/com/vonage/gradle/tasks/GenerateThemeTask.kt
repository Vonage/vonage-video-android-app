...
abstract class GenerateThemeTask : DefaultTask() {
    ...
    fun generate() {
        ...
        if (!themeFile.exists()) {
            throw IllegalArgumentException("Theme file does not exist: ${themeFile.absolutePath}")
        }
        ...
        if (!outputDirectory.exists()) {
            throw IllegalArgumentException("Theme directory does not exist: ${outputDirectory.absolutePath}")
        }
